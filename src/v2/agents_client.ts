...
export class AgentsClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this.agentsStub = gaxGrpc.createStub(
        opts.fallback ?
          (protos as protobuf.Root).lookupService('google.cloud.dialogflow.v2.Agents') :
    ...
    const agentsStubMethods =
        ['getAgent', 'setAgent', 'deleteAgent', 'searchAgents', 'trainAgent', 'exportAgent', 'importAgent', 'restoreAgent'];
