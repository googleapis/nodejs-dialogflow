...
export class ConversationsClient {
  ...
  initialize() {
    ...
    const conversationsStubMethods =
        ['createConversation', 'listConversations', 'getConversation', 'completeConversation', 'createCallMatcher', 'listCallMatchers', 'deleteCallMatcher', 'batchCreateMessages', 'listMessages'];
