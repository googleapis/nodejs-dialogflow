...
export class KnowledgeBasesClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._descriptors.page = {
      listKnowledgeBases:
          new gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'knowledgeBases')
    };
    ...
    this.knowledgeBasesStub = gaxGrpc.createStub(
        opts.fallback ?
          (protos as protobuf.Root).lookupService('google.cloud.dialogflow.v2beta1.KnowledgeBases') :
