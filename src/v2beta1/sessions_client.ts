...
export class SessionsClient {
  ...
  detectIntent(
      ...
      Promise<[
        ...
        protosTypes.google.cloud.dialogflow.v2beta1.IDetectIntentRequest|undefined, {}|undefined
      ]>;
  detectIntent(
      request: protosTypes.google.cloud.dialogflow.v2beta1.IDetectIntentRequest,
      options: gax.CallOptions,
      callback: Callback<
          protosTypes.google.cloud.dialogflow.v2beta1.IDetectIntentResponse,
          protosTypes.google.cloud.dialogflow.v2beta1.IDetectIntentRequest|undefined,
          {}|undefined>): void;
/**
 ...
 */
  ...
  matchProjectFromProjectAgentSessionName(projectAgentSessionName: string) {
    return this._pathTemplates.projectAgentSessionPathTemplate.match(projectAgentSessionName).project;
  }
  ...
  matchSessionFromProjectAgentSessionName(projectAgentSessionName: string) {
    return this._pathTemplates.projectAgentSessionPathTemplate.match(projectAgentSessionName).session;
  }
  ...
  matchProjectFromProjectLocationAgentSessionName(projectLocationAgentSessionName: string) {
    return this._pathTemplates.projectLocationAgentSessionPathTemplate.match(projectLocationAgentSessionName).project;
  }
  ...
  matchLocationFromProjectLocationAgentSessionName(projectLocationAgentSessionName: string) {
    return this._pathTemplates.projectLocationAgentSessionPathTemplate.match(projectLocationAgentSessionName).location;
  }
  ...
  matchSessionFromProjectLocationAgentSessionName(projectLocationAgentSessionName: string) {
    return this._pathTemplates.projectLocationAgentSessionPathTemplate.match(projectLocationAgentSessionName).session;
  }
