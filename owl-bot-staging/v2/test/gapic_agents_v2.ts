...
describe('v2.AgentsClient', () => {
    ...
    describe('getAgent', () => {
        it('invokes getAgent without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetAgentRequest', ['parent']);
    ...
    describe('setAgent', () => {
        it('invokes setAgent without error', async () => {
            ...
            request.agent ??= {};
            const defaultValue1 =
              getTypeDefaultValue('SetAgentRequest', ['agent', 'parent']);
    ...
    describe('deleteAgent', () => {
        it('invokes deleteAgent without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteAgentRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('getValidationResult', () => {
        it('invokes getValidationResult without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetValidationResultRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('trainAgent', () => {
        it('invokes trainAgent without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('TrainAgentRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('exportAgent', () => {
        it('invokes exportAgent without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ExportAgentRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('importAgent', () => {
        it('invokes importAgent without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ImportAgentRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('restoreAgent', () => {
        it('invokes restoreAgent without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('RestoreAgentRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('searchAgents', () => {
        it('invokes searchAgents without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('SearchAgentsRequest', ['parent']);
            request.parent = defaultValue1;
