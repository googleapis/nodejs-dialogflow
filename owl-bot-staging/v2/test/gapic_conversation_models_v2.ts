...
describe('v2.ConversationModelsClient', () => {
    ...
    describe('getConversationModel', () => {
        it('invokes getConversationModel without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v2.GetConversationModelRequest());
            request.name = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dialogflow.v2.ConversationModel());
            ...
            assert((client.innerApiCalls.getConversationModel as SinonStub)
    ...
    describe('getConversationModelEvaluation', () => {
        it('invokes getConversationModelEvaluation without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v2.GetConversationModelEvaluationRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dialogflow.v2.ConversationModelEvaluation());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getConversationModelEvaluation as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('createConversationModel', () => {
        it('invokes createConversationModel without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createConversationModel as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('deleteConversationModel', () => {
        it('invokes deleteConversationModel without error', async () => {
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.deleteConversationModel as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('deployConversationModel', () => {
        it('invokes deployConversationModel without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v2.DeployConversationModelRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.deployConversationModel as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('undeployConversationModel', () => {
        it('invokes undeployConversationModel without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v2.UndeployConversationModelRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.undeployConversationModel as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('createConversationModelEvaluation', () => {
        it('invokes createConversationModelEvaluation without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v2.CreateConversationModelEvaluationRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createConversationModelEvaluation as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listConversationModels', () => {
        it('invokes listConversationModels without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v2.ListConversationModelsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listConversationModels as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listConversationModelEvaluations', () => {
        it('invokes listConversationModelEvaluations without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v2.ListConversationModelEvaluationsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listConversationModelEvaluations as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('Path templates', () => {
        ...
        describe('projectConversationModelEvaluationsEvaluation', () => {
            const fakePath = "/rendered/path/projectConversationModelEvaluationsEvaluation";
            const expectedParameters = {
                project: "projectValue",
                conversation_model: "conversationModelValue",
            };
            ...
            it('projectConversationModelEvaluationsEvaluationPath', () => {
                const result = client.projectConversationModelEvaluationsEvaluationPath("projectValue", "conversationModelValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.projectConversationModelEvaluationsEvaluationPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchProjectFromProjectConversationModelEvaluationsEvaluationName', () => {
                const result = client.matchProjectFromProjectConversationModelEvaluationsEvaluationName(fakePath);
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.projectConversationModelEvaluationsEvaluationPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchConversationModelFromProjectConversationModelEvaluationsEvaluationName', () => {
                const result = client.matchConversationModelFromProjectConversationModelEvaluationsEvaluationName(fakePath);
                assert.strictEqual(result, "conversationModelValue");
                assert((client.pathTemplates.projectConversationModelEvaluationsEvaluationPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('projectLocationConversationModelEvaluationsEvaluation', () => {
            const fakePath = "/rendered/path/projectLocationConversationModelEvaluationsEvaluation";
            const expectedParameters = {
                project: "projectValue",
                location: "locationValue",
                conversation_model: "conversationModelValue",
            ...
            it('projectLocationConversationModelEvaluationsEvaluationPath', () => {
                const result = client.projectLocationConversationModelEvaluationsEvaluationPath("projectValue", "locationValue", "conversationModelValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.projectLocationConversationModelEvaluationsEvaluationPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchProjectFromProjectLocationConversationModelEvaluationsEvaluationName', () => {
                const result = client.matchProjectFromProjectLocationConversationModelEvaluationsEvaluationName(fakePath);
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.projectLocationConversationModelEvaluationsEvaluationPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchLocationFromProjectLocationConversationModelEvaluationsEvaluationName', () => {
                const result = client.matchLocationFromProjectLocationConversationModelEvaluationsEvaluationName(fakePath);
                assert.strictEqual(result, "locationValue");
                assert((client.pathTemplates.projectLocationConversationModelEvaluationsEvaluationPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchConversationModelFromProjectLocationConversationModelEvaluationsEvaluationName', () => {
                const result = client.matchConversationModelFromProjectLocationConversationModelEvaluationsEvaluationName(fakePath);
                assert.strictEqual(result, "conversationModelValue");
                assert((client.pathTemplates.projectLocationConversationModelEvaluationsEvaluationPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
