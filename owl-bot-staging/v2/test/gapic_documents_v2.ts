...
describe('v2.DocumentsClient', () => {
    ...
    describe('importDocuments', () => {
        it('invokes importDocuments without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v2.ImportDocumentsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('exportDocument', () => {
        it('invokes exportDocument without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v2.ExportDocumentRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.exportDocument as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
