...
describe('v2beta1.KnowledgeBasesClient', () => {
    ...
    describe('getKnowledgeBase', () => {
        it('invokes getKnowledgeBase without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetKnowledgeBaseRequest', ['name']);
    ...
    describe('createKnowledgeBase', () => {
        it('invokes createKnowledgeBase without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreateKnowledgeBaseRequest', ['parent']);
    ...
    describe('deleteKnowledgeBase', () => {
        it('invokes deleteKnowledgeBase without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteKnowledgeBaseRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('updateKnowledgeBase', () => {
        it('invokes updateKnowledgeBase without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('UpdateKnowledgeBaseRequest', ['knowledgeBase', 'name']);
    ...
    describe('listKnowledgeBases', () => {
        it('invokes listKnowledgeBases without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListKnowledgeBasesRequest', ['parent']);
            request.parent = defaultValue1;
