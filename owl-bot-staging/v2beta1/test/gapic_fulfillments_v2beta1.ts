...
describe('v2beta1.FulfillmentsClient', () => {
    ...
    describe('getFulfillment', () => {
        it('invokes getFulfillment without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v2beta1.GetFulfillmentRequest());
            request.name = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dialogflow.v2beta1.Fulfillment());
    ...
    describe('updateFulfillment', () => {
        it('invokes updateFulfillment without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v2beta1.UpdateFulfillmentRequest());
            request.fulfillment = {};
