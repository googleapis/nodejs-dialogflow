...
describe('v2beta1.ConversationProfilesClient', () => {
    ...
    describe('setSuggestionFeatureConfig', () => {
        it('invokes setSuggestionFeatureConfig without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v2beta1.SetSuggestionFeatureConfigRequest());
            request.conversationProfile = '';
    ...
    describe('clearSuggestionFeatureConfig', () => {
        it('invokes clearSuggestionFeatureConfig without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v2beta1.ClearSuggestionFeatureConfigRequest());
            request.conversationProfile = '';
            const expectedHeaderRequestParams = "conversation_profile=";
            const expectedOptions = {
                otherArgs: {
