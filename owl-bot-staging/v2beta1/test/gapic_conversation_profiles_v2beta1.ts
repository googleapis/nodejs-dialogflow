...
describe('v2beta1.ConversationProfilesClient', () => {
    ...
    describe('getConversationProfile', () => {
        it('invokes getConversationProfile without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2beta1.GetConversationProfileRequest', ['name']);
    ...
    describe('createConversationProfile', () => {
        it('invokes createConversationProfile without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2beta1.CreateConversationProfileRequest', ['parent']);
    ...
    describe('updateConversationProfile', () => {
        it('invokes updateConversationProfile without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2beta1.UpdateConversationProfileRequest', ['conversationProfile', 'name']);
    ...
    describe('deleteConversationProfile', () => {
        it('invokes deleteConversationProfile without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2beta1.DeleteConversationProfileRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('setSuggestionFeatureConfig', () => {
        it('invokes setSuggestionFeatureConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2beta1.SetSuggestionFeatureConfigRequest', ['conversationProfile']);
        ...
        it('invokes setSuggestionFeatureConfig without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.setSuggestionFeatureConfig(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.dialogflow.v2beta1.IConversationProfile, protos.google.cloud.dialogflow.v2beta1.ISetSuggestionFeatureConfigOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.dialogflow.v2beta1.IConversationProfile, protos.google.cloud.dialogflow.v2beta1.ISetSuggestionFeatureConfigOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.setSuggestionFeatureConfig as SinonStub)
                .getCall(0).args[0];
    ...
    describe('clearSuggestionFeatureConfig', () => {
        it('invokes clearSuggestionFeatureConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2beta1.ClearSuggestionFeatureConfigRequest', ['conversationProfile']);
            request.conversationProfile = defaultValue1;
            const expectedHeaderRequestParams = `conversation_profile=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
        ...
        it('invokes clearSuggestionFeatureConfig without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.clearSuggestionFeatureConfig(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.dialogflow.v2beta1.IConversationProfile, protos.google.cloud.dialogflow.v2beta1.IClearSuggestionFeatureConfigOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.dialogflow.v2beta1.IConversationProfile, protos.google.cloud.dialogflow.v2beta1.IClearSuggestionFeatureConfigOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.clearSuggestionFeatureConfig as SinonStub)
                .getCall(0).args[0];
    ...
    describe('listConversationProfiles', () => {
        it('invokes listConversationProfiles without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.dialogflow.v2beta1.ListConversationProfilesRequest', ['parent']);
            request.parent = defaultValue1;
