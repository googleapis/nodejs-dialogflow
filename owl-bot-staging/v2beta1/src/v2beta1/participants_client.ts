...
import {Callback, CallOptions, Descriptors, ClientOptions, GrpcClientOptions, PaginationCallback, GaxCall, GoogleError, LocationsClient, LocationProtos} from 'google-gax';
