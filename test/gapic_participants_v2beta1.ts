...
describe('v2beta1.ParticipantsClient', () => {
    ...
    describe('streamingAnalyzeContent', () => {
        it('invokes streamingAnalyzeContent without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v2beta1.StreamingAnalyzeContentRequest());
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dialogflow.v2beta1.StreamingAnalyzeContentResponse());
        ...
        it('invokes streamingAnalyzeContent with error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v2beta1.StreamingAnalyzeContentRequest());const expectedError = new Error('expected');
