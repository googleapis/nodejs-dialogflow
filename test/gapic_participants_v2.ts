    ...
    it('invokes createParticipant without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createParticipant(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.v2.IParticipant | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes analyzeContent without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.analyzeContent(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.v2.IAnalyzeContentResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes suggestArticles without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.suggestArticles(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.v2.ISuggestArticlesResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes suggestFaqAnswers without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.suggestFaqAnswers(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.v2.ISuggestFaqAnswersResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes suggestSmartReplies without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.suggestSmartReplies(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.v2.ISuggestSmartRepliesResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('listParticipants', () => {
    ...
    it('invokes listParticipantsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.dialogflow.v2.Participant) => {
