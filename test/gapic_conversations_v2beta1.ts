...
describe('v2beta1.ConversationsClient', () => {
    ...
    describe('createCallMatcher', () => {
        it('invokes createCallMatcher without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v2beta1.CreateCallMatcherRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dialogflow.v2beta1.CallMatcher());
        ...
        it('invokes createCallMatcher without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createCallMatcher(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v2beta1.ICallMatcher|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('deleteCallMatcher', () => {
        it('invokes deleteCallMatcher without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v2beta1.DeleteCallMatcherRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('listCallMatchers', () => {
        it('invokes listCallMatchers without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v2beta1.ListCallMatchersRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dialogflow.v2beta1.CallMatcher()),
              generateSampleMessage(new protos.google.cloud.dialogflow.v2beta1.CallMatcher()),
              generateSampleMessage(new protos.google.cloud.dialogflow.v2beta1.CallMatcher()),
            ];
        ...
        it('invokes listCallMatchersStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.dialogflow.v2beta1.CallMatcher) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
